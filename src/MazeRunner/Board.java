...
public class Board extends JPanel implements ActionListener {
    ...
    private final short[] levelData = {
        ...
        16, 0, 16, 0, 16, 256, 0, 16, 0, 0, 0, 0, 0, 16, 0, 16, 512, 16, 0, 16, 0, 16, 0, 0, 0, 0, 0, 16, 2, 16,
        16, 0, 16, 16, 16, 16, 16, 16, 0, 16, 16, 16, 16, 16, 0, 16, 0, 16, 0, 16, 0, 16, 0, 0, 0, 16, 16, 16, 0, 16,
        ...
        new Thread(() -> {
            try {
                ...
                inputStream = AudioSystem.getAudioInputStream(
                        Board.class.getResourceAsStream("/BGM.wav"));
